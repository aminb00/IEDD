...
# Funzione astratta per gestire i profili settimanali
save_weekly_profiles <- function(list_of_dfs, output_dir) {
  # Da implementare in futuro
  stop("Gestione dei profili settimanali non ancora implementata")
}

# Funzione astratta per gestire i profili mensili
save_monthly_profiles <- function(list_of_dfs, output_dir) {
  # Da implementare in futuro
  stop("Gestione dei profili mensili non ancora implementata")
}

# Funzione principale per gestire il salvataggio dei profili
process_profile <- function(nc_file_path, profile_name, start_year, output_dir) {
  ...
  if (profile_info[[profile_name]]$temporal_dim == "daily") {
    ...
    save_weekly_profiles(list_of_dfs, output_dir)
  } else if (profile_info[[profile_name]]$temporal_dim == "monthly") {
    save_monthly_profiles(list_of_dfs, output_dir)
  }
}
